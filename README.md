...
This repository contains the source code for training and evaluating models described in the pre-print *Trust, but Verify: Cross-Modality Fusion for HD Map Change Detection*.
...
This code and dataset are owned by Argo AI, LLC (Licensor), but are distributed with permission by John Lambert under CC BY-NC-SA 4.0. 
